...
app.get('/analytics', (req, res) => {
    // display analytics for the past 30 days
    ...
    for (let i = 0; i < 30; i++) {
        ...
        last30Days.unshift(date.toISOString().slice(0, 10)); // Add date to the beginning of the array
    }

    const analyticsData = last30Days.map(date => {
        return {
            date: date,
